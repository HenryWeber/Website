...
* The Book class
*/
@Data // Generates boilerplate code - @Getter , @Setter , @ToString, @RequiredArgsConstructor, @EqualsandHashCode
@AllArgsConstructor // Generates all arguments constructor
@Entity // Correlated with a table in a database
@Table(name="book") // Specifies what table the entity is mapped to
public class Book {

	/**The unique Book object's id that is auto-generated by the database
	 * 
	 */
	@Column(name="book_id")// Specifies column in the database
	@Id // Specifies primary key of an entity
	@GeneratedValue // Specifies how primary keys of an entity are created
	private int id;
